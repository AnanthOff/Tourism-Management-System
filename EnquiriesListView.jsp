...
<body>
	...
	<hr>
	<form action="<%=TMSView.ENQUIRIES_LIST_CTL%>" method="post"
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<input class="btn btn-outline-primary btn-md m-0 waves-effect"
						...
						value="<%=EnquiriesListCtl.OP_SEARCH%>"> Or <input
						class="btn btn-outline-primary btn-md m-0 waves-effect"
						type="submit" name="operation" aria-label="Search"
						value="<%=EnquiriesListCtl.OP_RESET%>">
				</div>
			</div>
		</div>
		...
		<table id="tablePreview"
			...
			<tbody>
				...
				Iterator<EnquiriesBean> iterator = list.iterator();
			...
			<tbody>
				<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=EnquiriesListCtl.OP_PREVIOUS%>"
					...
					<td><input type="submit" name="operation"
						class="btn btn-outline-primary btn-sm m-0 waves-effect"
						value="<%=EnquiriesListCtl.OP_NEXT%>"
