<%@page import="com.tourism.mgt.bean.IssuesBean"%>
<%@page import="com.tourism.mgt.ctl.IssuesListCtl"%>
...
<body>
	...
	<hr>
	<form action="<%=TMSView.ISSUES_LIST_CTL%>" method="post"
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<input class="btn btn-outline-primary btn-md m-0 waves-effect"
						...
						value="<%=IssuesListCtl.OP_SEARCH%>"> Or <input
						class="btn btn-outline-primary btn-md m-0 waves-effect"
						type="submit" name="operation" aria-label="Search"
						value="<%=IssuesListCtl.OP_RESET%>">
				</div>
			</div>
		</div>
		...
		<table id="tablePreview"
			...
			<tbody>
				...
				Iterator<IssuesBean> iterator = list.iterator();
			...
			<tbody>
				<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=IssuesListCtl.OP_PREVIOUS%>"
