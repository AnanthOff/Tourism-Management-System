	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<hr>
				<form action="<%=TMSView.ISSUES_CTL%>" method="post"
					>
					<jsp:useBean id="bean" class="com.tourism.mgt.bean.IssuesBean"
					...
					<div class="form-group">
						<div class="col-md-9 mb-4 md-form" style="padding-left: 0px">
							<label for="validationServerUsername55">Issue</label> <input
								type="text" class="form-control" name="issues"
								value="<%=DataUtility.getStringData(bean.getIssues())%>">
							<div>
								<font color="red" style="font-size: 13px"><%=ServletUtility.getErrorMessage("issues", request)%></font>
							</div>
						</div>
					</div>
					...
					<input type="submit" name="operation"
						...
						value="<%=IssuesCtl.OP_SAVE%>"> or <input
						type="submit" name="operation"
						class="btn btn-primary btn-sm btn-rounded"
						value="<%=IssuesCtl.OP_RESET%>">
				</form>
